...
function Route({ path, onEnter, onExit, isExact, children }) {
    ...
    return mobx_observer_hook_1.useObserver(() => routeDef.isActive ? React.createElement(InnerRoute, { onExit: onExit, params: routeDef.params, onEnter: onEnter }, children) : null, [router, routeDef]);
}
exports.Route = Route;
